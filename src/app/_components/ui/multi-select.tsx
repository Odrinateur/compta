...
const CommandEmpty = ({ className, ...props }: React.ComponentProps<typeof CommandPrimitive.Empty>) => {
    ...
    return <div className={cn('px-2 py-4 text-sm text-center', className)} cmdk-empty='' role='presentation' {...props} />
}
...
const MultipleSelector = ({
    ...
    return (
        ...
        >
            <div
                className={cn(
                    'has-disabled:opacity-50 border border-input has-aria-invalid:border-destructive focus-within:border-ring rounded-md outline-none has-aria-invalid:ring-destructive/20 focus-within:ring-[3px] focus-within:ring-ring/50 dark:has-aria-invalid:ring-destructive/40 relative has-disabled:cursor-not-allowed has-disabled:pointer-events-none min-h-[38px] transition-[color,box-shadow] text-sm',
                    {
            ...
            >
                <div className='flex flex-wrap gap-1'>
                    {selected.map(option => {
                        return (
                            <div
                                key={option.value}
                                className={cn(
                                    'bg-background hover:bg-background disabled:opacity-50 border rounded-md inline-flex relative items-center pr-7 data-fixed:pr-2 pl-2 cursor-default disabled:cursor-not-allowed disabled:pointer-events-none h-7 transition-all animate-fadeIn font-medium text-secondary-foreground text-xs',
                                    badgeClassName
                                )}
                    ...
                    <CommandPrimitive.Input
                        ...
                        className={cn(
                            'bg-transparent outline-hidden hidden sm:block flex-1 disabled:cursor-not-allowed placeholder:text-muted-foreground/70',
                            {
            ...
            <div className='relative'>
                <div
                    className={cn(
                        'border border-input rounded-md top-2 z-10 absolute w-full overflow-hidden',
